...
import Eventnotificationformatapp from "../common-items/_event-notification-format-app.mdx";

<Eventnotificationformatapp /> 

---

{/* 서버 경고 알림 */}

import Eventnotificationformatserver from "../common-items/_event-notification-format-server.mdx";

<Eventnotificationformatserver /> 