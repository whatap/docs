...
* ![지시선 a](/img/char-a.svg) 데이터 수집 토글 ![아이콘](/img/ic-toggle-off.svg) 비활성화 시 이후 비용이 발생하지 않습니다.

* ![지시선 b](/img/char-b.svg) ***역할(Role) 변경*** 버튼을 선택해 에이전트 설치 화면에서 ![지시선 c](/img/char-c.svg) ***서비스 초기화*** 선택 시 인증 정보 및 데이터 수집 정보를 초기화해 이후 비용이 발생하지 않습니다.
