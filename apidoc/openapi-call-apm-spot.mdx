...
| threadpool_active | <span class='api'>string</span> | [쓰레드풀 활성 쓰레드 수](#count-threadpool) |
| threadpool_queue | <span class='api'>string</span> | 쓰레드풀 큐잉 쓰레드 수 |
