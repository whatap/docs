...
| threadpool_active | <span class='api'>string</span> | [스레드풀 활성 스레드 수](#count-threadpool) |
...
| apdex | <span class='api'>number</span> | [Apdex](#apdex)([Application Performance Index](https://www.apdex.org/), 애플리케이션의 사용자 만족도) |
