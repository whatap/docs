...
Node.js 에이전트 이름 설정에 관한 자세한 설명은 [다음 설명서](nodejs-set-agent#agentname)를 참조하세요.
...
기본값 `512`<br/>프로파일 정보를 제외한 나머지 데이터 전송에 사용할 Queue의 크기를 설정합니다.

* **net_send_queue2_size** <span class='type'>Int</span><br/>
기본값 `1024`<br/>프로파일 정보 전송에 사용할 Queue의 크기를 설정합니다.
