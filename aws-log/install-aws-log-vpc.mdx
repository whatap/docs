...
본 문서는 **VPC** 환경에서 **WhaTap Forwarder**를 사용하기 위한 추가 설정을 안내합니다. 먼저 **WhaTap Forwarder**를 설치하세요. 자세한 내용은 [다음 문서](../aws-log/install-aws-log#install-whatap-forwarder)를 참조하세요.
