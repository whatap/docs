...
![IAM 정책 생성 sc](/img/aws-log-create-policy.png)
...
![AWS CloudWatch Log 조회 및 구독 sc](/img/aws-log-cloudwatch-subs.png)
...
![AWS S3 Bucket 조회 및 구독 sc](/img/aws-log-s3-subs.png)
...
![AWS Log 모니터링 시작하기](/img/aws-log-start.png)
