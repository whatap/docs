...
1. 상단 오른쪽의 ![number 1](/img/number-01.png) ***갱신*** 버튼을 선택해 스택의 생성 진행 상태를 확인하세요. 
  ...
  :::
1. 하단 오른쪽의 ![number 2](/img/number-02.png) ***aws-log-demo-whatapforwarder-…*** 을 선택해 **WhaTap Forwarder**의 상세 화면으로 이동하세요.
1. 상세 화면 오른쪽의 ***Description*** 영역에서 ![number 3](/img/number-03.png) ***Function ARN***을 복사하세요.
...
1. ***Select type of trusted entity***에서 ***AWS account***를 선택하세요.
1. ***Account ID***에 와탭 계정(**911937781722**)을 입력하세요.
  ![IAM Role ARN](/img/aws-log-create-role-entity.png)
...
1. 생성된 ***IAM Role ARN***을 복사하세요.
  ![IAM Role ARN](/img/aws-log-iam-role-arn.png)
