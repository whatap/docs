...
**Whatap Amazon CloudWatch 모니터링**은 API 연동을 통해 메트릭 데이터를 자동 수집합니다. 사용자는 CloudWatch 서비스에서 원하는 스탯(통계 항목)을 선택해 수집할 수 있으며, 모든 리전(지역)의 자원을 탐색해 모니터링 할 수 있습니다. Role 기반 인증 방식으로 안전하고 편리하게 사용할 수 있습니다.
...
[Step 1. Amazon 인증 정보를 입력하세요.](#authentication)  
[Step 2. CloudWatch 서비스 및 수집 주기를 선택하세요.](#namespace-and-collecting-period)  
[Step 3. 리전, 메트릭스, 스탯을 선택하세요.](#region-metric-stats)

:::caution

설치 후 사용량에 따라 와탭 요금과 별개로 클라우드에서 추가 비용이 발생할 수 있습니다. 설치 전 사용 중인 클라우드 서비스의 가격 정책을 [다음 문서](https://aws.amazon.com/ko/cloudwatch/pricing/)에서 확인하세요.
...
#### Amazon CloudWatch 서비스 {#namespace}
...
1. 수집 토글을 ![아이콘](/img/ic-toggle-off.svg) 비활성화하면 데이터 수집이 중지됩니다.
