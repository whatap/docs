홈 화면 > 프로젝트 선택 > ***분석*** > ***트랜잭션***

와탭 모니터링 서비스 초기 화면에서 프로젝트를 선택한 다음 ***프로젝트 메뉴*** 하위에 ***분석*** > ***트랜잭션***을 선택하세요. 와탭 에이전트는 트랜잭션 정보, SQL과 같은 주요 프로파일 정보에 대해 통계 정보를 수집합니다. 5분마다 목록을 만들고 서버로 전송합니다.
