...
* 테이블 목록에서 ***query_text*** 컬럼 항목을 선택하면 <Cmdname sid="TTL06224" className="uitext" /> 창이 나타납니다. <Cmdname sid="TTL06224" className="uitext" /> 창에 대한 자세한 내용은 [다음 문서](usage-ui#query-details)를 참조하세요.
