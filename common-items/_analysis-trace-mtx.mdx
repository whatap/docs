...
<Cmdname sid="BTN06296" className="uitext" /> 탭에서 각 트랜잭션과 그에 속해 있는 트레이스의 세부 정보를 확인할 수 있습니다. 전체 트랜잭션 소요 시간 내의 각 하위 트랜잭션이나 트레이스의 시작 및 소요 시간을 시각화해 트랜잭션 호출 관계를 트리 형식으로 제공합니다.

* ![한 줄 보기 아이콘](/img/ic-single-line.svg) <Cmdname sid="BTN06368" className="uitext" />: 구간별 수행 정보에 표시된 텍스트를 한 줄로 표시해 트리 형식을 간격하게 정리함

* ![여러 줄 보기 아이콘](/img/ic-multi-line.svg) <Cmdname sid="BTN06369" className="uitext" />: 구간별 수행 정보에 표시된 텍스트를 줄바꿈해 모두 표시함

* <Cmdname sid="BTN06327" className="uitext" />: 가장 긴 경로로 이동함

* ![차트 아이콘](/img/ic-bar-chart.svg) <Cmdname sid="BTN06743" className="uitext" />: 경과 시간을 막대 형식의 차트로 표시

* ![시간 아이콘](/img/ic-custom-time.svg) <Cmdname sid="BTN06744" className="uitext" />: 구간별 타임 스탬프, 갭, 경과 시간을 텍스트 형식으로 표시

  * 8초 이상: <span class='etrs'>초과 지연</span> 상태로 <span class='etrs'>빨간색</span>으로 표현

  * 3초 이상 8초 미만: <span class='ov5ud10'>지연</span> 상태로 <span class='ov5ud10'>주황색</span>으로 표현

  * 3초 미만: <span class='woer'>정상</span> 상태로 <span class='woer'>파란색</span>으로 표현
...
* ![감추기 아이콘](/img/ic-eye-invisible.svg) <Cmdname sid="BTN06745" className="uitext" />: 시간 정보를 숨김
