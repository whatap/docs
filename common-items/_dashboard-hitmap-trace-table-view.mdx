...
<ProdImg img="analysis-tx-table-view-mode.png" desc="테이블 뷰" />

</Xclude>

<InDoc product='php,nodejs,golang'>

<ProdImg img="analysis-tx-table-view-mode-none-actx.png" desc="테이블 뷰" />
...
* 다이어그램의 각 구간을 선택하면 해당 스텝이 위치한 테이블 목록으로 이동합니다.
  ...
  <ProdImg img="analysis-tx-table-view-select-stack.png" desc="스텝 선택" />
...
* 다이어그램의 각 구간을 선택하면 해당 스텝이 위치한 테이블 목록으로 이동합니다.
  ...
  <ProdImg img="analysis-tx-table-view-select-stack-none-actx.png" desc="스텝 선택" />
