...
<Xclude product="oracle-pro,sapase">
...
<InDoc product="oracle,postgresql,mssql,altibase,tibero,db2,sapase">
...
* **ipckey** <span class='type'>String</span>
  ...
  `ipcs` 명령은 프로세스 간 통신(IPC)에 대한 정보를 제공합니다. `-m` 옵션은 공유 메모리 자원을 조회합니다.
