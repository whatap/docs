## DB 서버에 부가 에이전트(XOS) 설치 및 기타 옵션 적용하기
...
<ImgLang img='db-xos-architecture.png' desc='XOS Agent' width="1200px" />
...
* <Cmdname sid="side_agentInstall" className="uitext" /> 메뉴에서 <UI>AWS RDS Region</UI>, <UI>Access Key</UI>, <UI>Secret Key</UI>, <UI>RDS DB Instance Name</UI>, <UI>DB Instance Name</UI> 항목에 필요한 정보를 입력하면 에이전트 옵션 및 명령어를 자동 생성할 수 있습니다. 
