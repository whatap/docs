...
<InDoc product="postgresql,mysql,oracle,oracle-v1,cubrid,redis,mongodb,altibase,altibase-v1">
...
<InDoc product="postgresql,mysql,oracle,oracle-v1,cubrid,tibero,altibase,altibase-v1">
