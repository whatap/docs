...
* **5분** (3시간 이상 조회 시)
  ...
  ***Lock Wait Sessions***에서 클릭한 시간에 발생한 Max Lock을 기준으로 ***1-Min Lock Trends***와 ***Lock Tree*** 테이블 내 시간을 적용합니다. 선택한 시간 내에서 발생한 락의 개수를 보여주며, 차트에서 바의 색상이 진하게 표시됩니다. 
  
  * `14:35:00`에 클릭한 경우, `14:35:00~14:40:00`까지의 데이터를 분석하여 락 발생 현황을 확인할 수 있습니다. 

  * `09:25:00`에 클릭한 경우, ***1-Min Lock Trends*** 차트에서 `09:25:00~09:30:00` 사이의 ***Max Lock***이 발생한 시간을 기준으로 락 발생 현황을 확인할 수 있습니다.
