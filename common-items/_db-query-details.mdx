...
<InDoc product="oracle-pro"><ImgLang img="db-sql-details-oracle-pro.png" desc="SQL 상세" /></InDoc>

<InDoc product="postgresql,mysql"><ImgLang img="db-sql-details-postgresql.png" desc="SQL 상세" /></InDoc>

<Xclude product="postgresql,mysql,oracle-pro"><ImgLang img="db-sql-details-common.png" desc="SQL 상세" /></Xclude>
