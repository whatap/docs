...
현재 수행 중인 세션의 SQL 쿼리 정보를 확인하려면 <Cmdname sid="active_sessions" className="uitext" /> 섹션의 ***query*** 컬럼 항목을 선택하세요. <Cmdname sid="TTL06224" className="uitext" /> 창이 나타납니다. SQL 쿼리문과 Plan 정보를 확인할 수 있습니다.
...
화면 아래에 SQL 목록에서 ***query*** 컬럼 항목을 선택하면 <Cmdname sid="TTL06224" className="uitext" /> 창이 나타납니다. SQL 쿼리문과 Plan 정보를 확인할 수 있습니다.
