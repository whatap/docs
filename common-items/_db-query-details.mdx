<Title hashid="query-details" level={props.level}>쿼리 자세히 보기</Title>
...
<InDoc product="db2"><ImgLang img="db-sql-details-db2.png" desc="SQL 상세" /></InDoc>

<Xclude product="postgresql,mysql,oracle-pro,oracle,mssql,db2"><ImgLang img="db-sql-details-common.png" desc="SQL 상세" /></Xclude>
