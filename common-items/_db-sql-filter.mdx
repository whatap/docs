...
1. <Cmdname sid="filter" className="uitext" /> 옵션에서 <LinkImage img="ico-add.svg" className="ico" /> 버튼을 선택하세요.
    ...
    <InDoc pages="analysis-sql,job-info,backup-recovery-history"><ImgLang img='db-analysis-sql-plan-change-filter-01.png' desc='조건 추가하기' /></InDoc>
...
<InDoc pages="analysis-sql,job-info,backup-recovery-history"><ImgLang img='db-sql-analysis-filter-modify.png' desc='필터 수정하기' /></InDoc>
