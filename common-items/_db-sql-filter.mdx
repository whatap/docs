...
1. <Cmdname sid="filter" className="uitext" /> 옵션에서 <LinkImage img="ico-add.svg" className="ico" /> 버튼을 클릭하세요.
...
* 조건 추가 중 일부 항목을 삭제하려면 필터 조건 오른쪽에 ![삭제 아이콘](/img/ico-trash.svg) 버튼을 클릭하세요. 전체 조건을 삭제하려면 ![삭제 아이콘](/img/ico-trash.svg) <Cmdname sid="BTN06616" className="uitext" /> 버튼을 클릭하세요.
