...
<InDoc product='mysql'><ProdImg img='db-top-sql-stat-mysql.png' desc='Top SQL' /></InDoc>

<InDoc product='oracle,oracle-pro'><ProdImg img='db-top-sql-stat.png' desc='Top SQL' /></InDoc>
...
* 데이터는 10~100건까지 테이블에 표시합니다. <Cmdname sid="TTL07773" className="uitext" />에서 테이블에 표시할 건 수를 설정할 수 있습니다. 설정을 완료한 다음 <LinkImage img="ico-btn-search.png" className="ico" /> 버튼을 선택하세요.
...
![숫자 3](/img/number-03.png) ***Trends*** 차트의 SQL 통계 데이터 수집 주기와 데이터 조회 범위는 아래 기준에 따라 다릅니다. 
