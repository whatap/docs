...
<Xclude product='cubrid,oracle-pro,mssql'><ImgLang img='agent-xos-architecture.png' desc='에이전트 구성도' /></Xclude>

<InDoc product='cubrid'><ImgLang img='dbx-install-agent-on-agent-server-cubrid.png' desc='에이전트 구성도' /></InDoc>

<InDoc product="oracle-pro"><ImgLang img='dbx-install-agent-on-db-server-dma.png' desc='에이전트 구성도' /></InDoc>

<InDoc product="mssql"><ImgLang img="agent-architecture.png" desc="Agent" /></InDoc>
...
<Xclude product='cubrid,oracle-pro,mssql'>
