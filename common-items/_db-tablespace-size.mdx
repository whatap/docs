...
<InDoc product="oracle,oracle-pro,cubrid"><ImgLang img="db-stat-table-space-size-details-oracle-pro.png" desc="Tablespace size" /></InDoc>

<InDoc product="tibero"><ImgLang img="db-stat-table-space-size-details-tibero.png" desc="Tablespace size" /></InDoc>

<InDoc product="oracle,oracle-pro,cubrid,tibero">
