...
- **이벤트 레벨**: Info(회색), Warning(주황색), Critical(빨간색)으로 구분
...
- **복잡한 패턴**: `*`이 3개 이상 포함된 패턴은 완전히 지원되지 않을 수 있습니다.
...
[Condition]
url patterns: /api/posts/**, /delete/*, */test/*, /eureka/app/ACCOUNT/ACCOUNT/*
...
## Support Agent Version {#support-agent-version}
