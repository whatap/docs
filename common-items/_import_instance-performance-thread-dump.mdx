...
<Cmdname sid="thread_list" className="uitext" /> 메뉴에서 확인할 수 있는 개별 스레드 덤프 정보에 대해 안내합니다. <Cmdname sid="thread_dump" className="uitext" /> 기능을 각 자바 버전별로 사용하기 위해서는 추가적인 JVM 옵션 설정이 필요합니다. 
