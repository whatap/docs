...
***건수*** 기준으로 정렬 후 ***호스트*** 및 ***포트***를 확인하여 어떤 서비스 또는 시스템과 연결이 많은지 확인할 수 있습니다. 이후 ***스택***을 확보해 상세 내용을 조회해 보세요. 예를 들어 3306 ***포트***의 ***건수***가 높다면 커넥션 풀을 사용하지 않거나 또는 커넥션 풀을 빈번하게 끊고 다시 만드는 등 MySQL의 커넥션 관리가 올바르게 이루어지지 않는 상황일 가능성이 있습니다. 해당 3306 ***포트***가 어떤 코드 경로에서 사용되고 있는지 파악하기 위해 ***스택***을 확보하여 추적할 수 있습니다. 
