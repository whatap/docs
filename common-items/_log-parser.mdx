...
1. <Cmdname sid="category" className="uitext" /> 및 <Cmdname sid="ITM06439" className="uitext" />, <Cmdname sid="pattern" className="uitext" />을 입력하세요. <Cmdname sid="parser" className="uitext" /> <Cmdname sid="add" className="uitext" /> 창의 구성 요소는 다음과 같습니다. 
...
* 파서를 등록하기 전에 <Cmdname sid="simulation" className="uitext" />을 통해 등록하려는 패턴이 정상적인지 확인할 수 있습니다. 
...
1. <Cmdname sid="category" className="uitext" /> 및 <Cmdname sid="ITM06439" className="uitext" />, <Cmdname sid="pattern" className="uitext" />을 입력하세요. <Cmdname sid="parser" className="uitext" /> <Cmdname sid="add" className="uitext" /> 창의 구성 요소는 다음과 같습니다. 
    ...
    * <Cmdname sid="pattern" className="uitext" />
      ...
      * JSON 패턴 예시
        ...
        예시 로그에서 ***Prefix***와 ***Postfix***를 `url`로 지정하고 ***Ignore***에 `url`을 지정 시 `host`, `method`, `status` 3개의 <Cmdname sid="tag" className="uitext" />만 생성됩니다.
