...
컬럼을 추가하거나 순서를 설정할 수 있습니다. <InDoc pages="log-search,aws-log-search,log-exp,aws-log-exp"><LinkImage img="number-03.png" className="ico" /> 영역 오른쪽</InDoc><InDoc pages="log-lt,aws-log-lt">화면 오른쪽</InDoc>에서 ![컬럼 아이콘](/img/ic-column.svg) <Cmdname sid="column_settings" className="uitext" /> 버튼을 클릭하세요. 
...
<InDoc pages="log-search,aws-log-search,log-exp,aws-log-exp"><LinkImage img="number-03.png" className="ico" /> 영역 오른쪽에서 ![설정 아이콘](/img/ic-setting.svg) <Cmdname sid="ITM08349" className="uitext" /> 버튼을 선택하세요. 기본으로 **content**, <Cmdname sid="tag" className="uitext" /> 모두 체크가 되어있으며 두 가지 항목 모두 표시합니다. **content**와 <Cmdname sid="tag" className="uitext" /> 중 하나는 반드시 선택하세요. </InDoc>

<InDoc pages="log-lt,aws-log-lt"> 

1. 화면의 오른쪽에서 ![설정 아이콘](/img/ic-setting.svg) <Cmdname sid="ITM08349" className="uitext" /> 버튼을 클릭하세요. 

1. **로그 표시 상세 설정** 창에서 **content**와 <Cmdname sid="tag" className="uitext" /> 중 하나는 반드시 선택하세요. 
    * 기본으로 **content**, <Cmdname sid="tag" className="uitext" /> 모두 선택되어있으며 두 가지 항목 모두 표시합니다. 
