...
| 컬럼                       | 설명                                                    | 타입 |
| -------------------------- | ------------------------------------------------------- | -- |
| <Cmdname sid="ITM07683" /> | HTTP 호출 URL 해시(hash)                                | u4 |
| <Cmdname sid="TTL06918" /> | 해당 HTTP API를 요청한 URL 중 하나를 임의로 수집한 정보 | u4 |
| 호스트                     | Host 또는 IP 주소                                       | u4 |
| 포트                       | TCP 포트                                                | u4 |
| 전체                       | 전체 수행 건수                                          | u4 |
| 에러                       | 에러 발생 건수                                          | u4 |
| 평균 시간 (ms)             | 응답시간 합계에 대한 평균                               | u8 |
| 합계 시간 (ms)             | 응답시간의 합                                           |  u8 |
| 최소 시간 (ms)             | 최소 응답시간                                           | u4 |
| 최대 시간 (ms)             | 최대 응답시간                                           | u4 |
