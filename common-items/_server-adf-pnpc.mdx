프로세스 File Descriptor 정보는 <Cmdname sid="side_serverList" className="uitext" /> &gt; <Cmdname sid="side_serverDetail" className="uitext" /> 화면의 <Cmdname sid="sms_summary_process" className="uitext" /> 위젯에서 확인할 수 있습니다.
