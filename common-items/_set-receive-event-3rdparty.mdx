...
## AI 알림 받기 <code className="Beta">Beta</code>
...
<Cmdname sid="3rd_party_plugin" className="uitext" /> 섹션의 Telegram 항목에서 <Cmdname sid="ITM08845" className="uitext" /> 옵션을 선택하세요. <Cmdname sid="ITM08845" className="uitext" /> 옵션을 활성화하면 사용자는 알림을 Telegram에서 다음과 같이 요약된 형태로 받을 수 있습니다.
