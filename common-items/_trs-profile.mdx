...
![profile_apm](/img/best-p/hitmap-transaction-sample-05.png)
...
#### ![number3](/img/number-03.png) 트레이스와 트레이스 트리뷰

트랜잭션 트레이스를 상세히 볼 수 있습니다. ![number-s3](/img/number-03.png) 영역의 ***프로파일***을 클릭하면 액티브 스택 스텝이 나타납니다. 또한 ***트레이스 트리*** 버튼을 클릭하면 다음과 같이 트리뷰 형태로 분석을 볼 수 있습니다.
...
1. 설정 적용 후 ***트레이스 스텝*** 내 ***SQL*** 문을 클릭하면 파라미터를 조회할 수 있습니다.
