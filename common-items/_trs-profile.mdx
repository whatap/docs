...
***프로파일 다이어그램***은 트랜잭션 수행 상세 이력입니다. 수행 상세 이력을 보여주기 위한 각 컬럼의 **트랜잭션 트레이스 정보**는 다음과 같습니다.
...
트랜잭션 트레이스를 상세히 볼 수 있습니다. ![number-s3](/img/number-03.png) 영역의 ***프로파일***을 클릭하면 액티브 스택 스텝이 나타납니다. 또한 ***프로파일 트리*** 버튼을 클릭하면 다음과 같이 트리뷰 형태로 분석을 볼 수 있습니다.
