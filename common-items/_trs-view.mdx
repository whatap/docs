...
지연 문제가 있는 트랜잭션이 포함된 경우 ***히트맵 트랜잭션*** 차트에서 <span class='ov5ud10'>노란색</span>이나 <span class='etrs'>붉은색</span>으로 표시됩니다. 정상 트랜잭션만 포함된 경우 <span class='woer'>파란색</span>으로 표시됩니다.
