## 서버 알림 템플릿 {#server-alert-template}
...
## 서버 경고 알림 {#server-alert-title-message}
...
### 로그 파일과 윈도우 이벤트 {#log-and-windows-alert}
