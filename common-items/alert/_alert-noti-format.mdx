...
import Alertnotiformatapp from "./_alert-noti-format-app.mdx";
import Alertnotiformatserver from "./_alert-noti-format-server.mdx";
...
<InDoc product="java,nodejs,php,dotnet,python,fo">
