...
:::note
쿠버네티스 상에서 실행 중인 애플리케이션을 추적하기 위해서는 Java, Node.js, Python 등의 각 애플리케이션 컨테이너에 와탭 모니터링 에이전트가 설치되어야 합니다. 에이전트 설치에 대한 자세한 내용은 [다음 설명서](../kubernetes/install-application-agent)를 참조하세요.
:::
