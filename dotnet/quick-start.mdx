...
tags: [ 애플리케이션, .NET, 에이전트 설치, 트러블슈팅, 빠른 시작하기 ]
---
...
![데이터 미수집](/img/dotnet-trst01.png)

예시와 같이 ***애플리케이션 대시보드***에서 모든 정보가 정상적으로 수집되지 않는 경우 다음을 확인하세요. 
...
![히트맵 데이터 미수집](/img/dotnet-trst02.png)
...
1. 다음 링크에서 *GetNamesapces.exe* 파일은 다운로드하세요. 

  * [https://repo.whatap.io/windows/GetNamesapces.exe](https://repo.whatap.io/windows/GetNamesapces.exe)
