...
Spring 프레임워크에서는 `org.springframework.web.servlet.DispatcherServlet.processHandlerException` 메소드를 통과하는 경우 에러로 처리합니다. 다만 Try-Catch 문을 사용하는 경우 `ExceptionHandler`로 에러 처리하지 않습니다.
