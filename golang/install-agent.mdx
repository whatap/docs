...
리눅스 환경의 Go 애플리케이션에 WhaTap 모니터링 에이전트를 설치하는 방법을 안내하며, 아래 3단계를 순차적으로 진행합니다.

- **[Step 1. Go 라이브러리 적용하기](#import-golib)**  
- **[Step 2. 모니터링 환경 변수 설정하기](#set-whatap-conf)**  
- **[Step 3. 데이터 중계용 에이전트 설치하기](#download_agent)**   
...
- [Docker 설치 가이드](install-agent-docker) - Docker 환경 설치