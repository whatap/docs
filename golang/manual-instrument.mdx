...
Go 라이브러리를 이용해 와탭 에이전트에 모니터링할 데이터를 수동으로 전송할 수 있습니다. 예제 코드는 [github.com/whatap/go-api-example](https://github.com/whatap/go-api-example)에서 확인할 수 있습니다.

:::note

**자동 적용 vs 수동 적용**

* **자동 적용 (권장)**: [자동 적용 가이드](auto-instrument)를 참조하여 코드 자동 삽입
