...
1. Region, Metric, Stats 선택하세요.

:::note
설치 후 사용량에 따라 와탭 요금과는 별개로 클라우드에서 추가 비용이 발생할 수 있습니다. 설치 전 사용 중인 클라우드 서비스의 가격 정책을 [다음 설명서](https://aws.amazon.com/ko/cloudwatch/pricing/)에서 확인하세요.
:::
...
### Cloudwatch Namespace 및 수집 주기 선택
...
### Cloudwatch Region, Metric, Stats 선택
