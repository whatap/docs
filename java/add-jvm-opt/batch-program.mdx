...
다음 링크를 통해 배치 애플리케이션 모니터링을 위한 에이전트를 다운로드할 수 있습니다.

<Link to='https://s3.ap-northeast-2.amazonaws.com/repo.whatap.io/agent/whatap.agent.batch-2.2.3.jar' class='ext-link'>에이전트 다운로드</Link>
