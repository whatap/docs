...
keywords: [ Java, 애플리케이션, Transaction, 트랜잭션, 에이전트 ]
---
...
Java 에이전트의 예외 처리 기준에 대한 자세한 내용은 [다음 문서](trs-view#java-agent-exception)를 참조하세요.
...
* **trace_malloc_enabled** <span class='type'>Boolean</span>
  ...
  해당 옵션의 값을 `true`로 설정하여 활성화 시 <Cmdname sid="TTL06209" className="uitext" /> 창의 <Cmdname sid="TTL06125" className="uitext" /> 탭에서 <Cmdname sid="TTL06974" className="uitext" />을 확인할 수 있습니다. 자세한 내용은 [다음 문서](/java/dashboard-hitmap-trace#anlaysis-trace-record-summary)를 참조하세요.
