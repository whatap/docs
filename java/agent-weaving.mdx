...
| camel-cxf Version | 설정 값                |
| ----------------- | ---------------------- |
| 3.15 이상         | weaving=camel-cxf-3.15 |
...
| camel-netty4 Version | 설정 값                   |
| -------------------- | ------------------------- |
| 2.25 이상            | weaving=camel-netty4-2.25 |
...
| camel-seda Version | 설정 값                 |
| ------------------ | ----------------------- |
| 2.22 이상          | weaving=camel-seda-2.22 |
| 3.2 이상           | weaving=camel-seda-3.2  |
...
| DynamoDB Version | 설정 값               |
| ---------------- | --------------------- |
| 1.11             | weaving=dynamodb-1.11 |
| 2.25             | weaving=dynamodb-2.25 |
...
| Hystrix Version | 설정 값             |
| --------------- | ------------------- |
| 1.5 이상        | weaving=hystrix-1.5 |
...
| Kafka Version            | 설정 값                     |
| ------------------------ | --------------------------- |
| kafka-clients 2.4.0 이상 | weaving=kafka-clients-2.4.0 |
| reactor-kafka 1.3 이상   | weaving=reactor-kafka-1.3   |
...
| Logback Version | 설정 값               |
| --------------- | --------------------- |
| 1.2.8 이상      | weaving=logback-1.2.8 |
...
| MongoDB Version | 설정 값             |
| --------------- | ------------------- |
| 3.8.2 ~ 4.8     | weaving=mongodb-3.8 |
| 3.8.2 ~ 5.0     | weaving=mongodb-5.0 |
...
| Mule Version | 설정 값            |
| ------------ | ------------------ |
| 3.9.5 이상   | weaving=mule-3.9.5 |
| 4.5 이상     | weaving=mule-4.5   |
...
| OkHttp Version | 설정 값             |
| -------------- | ------------------- |
| 2.7 이상       | weaving=okhttp-2.7  |
| 3.x            | weaving=okhttp3     |
| 3.x (4.4 이상) | weaving=okhttp3-4.4 |
...
| Quarkus Reactive Version | 설정 값                       |
| ------------------------ | ----------------------------- |
| 1.13 이상                | weaving=quarkus-reactive-1.13 |
| 2.10 이상                | weaving=quarkus-reactive-2.10 |
...
| reactor-rabbitmq Version | 설정 값                      |
| ------------------------ | ---------------------------- |
| 1.2 이상                 | weaving=reactor-rabbitmq-1.2 |
...
| Jedis Version | 설정 값           |
| ------------- | ----------------- |
| 2.9.0 ~ 2.9.3 | weaving=jedis-2.9 |
| 3.2           | weaving=jedis-3.2 |
...
| Lettuce Version | 설정 값             |
| --------------- | ------------------- |
| 5.1             | weaving=lettuce-5.1 |
| 5.1 ~ 6.2       | weaving=lettuce-6.2 |
...
| Retrofit Version | 설정 값              |
| ---------------- | -------------------- |
| 2.5 이상         | weaving=retrofit-2.5 |
...
| Spring Boot Version     | 설정 값                 |
| ----------------------- | ----------------------- |
| spring-boot 2.1 ~ 2.4.x | weaving=spring-boot-2.1 |
| spring-boot 2.5 ~ 2.6.x | weaving=spring-boot-2.5 |
| spring-boot 2.7 ~ 2.9.x | weaving=spring-boot-2.7 |
| spring-boot 3.0 ~ 3.1.x | weaving=spring-boot-3.0 |
| spring-boot 3.2 ~ 3.3.x | weaving=spring-boot-3.0 |
...
| Undertow Version | 설정 값              |
| ---------------- | -------------------- |
| 2.2 ~ 2.3        | weaving=undertow-2.2 |
| 2.3              | weaving=undertow-2.3 |
