...
tags: [ Java, 트랜잭션, 애플리케이션, 분석하기, 통계, UI ]
---

<!-- {@include: ../common-items/_analysis-apm-trs.mdx} -->

홈 화면 &gt; 프로젝트 선택 &gt; <Cmdname sid="statistic" className="uitext" />

와탭 모니터링 서비스 초기 화면에서 프로젝트를 선택한 다음 <Cmdname sid="statistic" className="uitext" />의 하위 메뉴를 선택하세요. 와탭 에이전트는 트랜잭션 정보, SQL과 같은 주요 트레이스 정보에 대해 통계 정보를 수집합니다. 5분마다 목록을 만들고 서버로 전송합니다.
...
홈 화면 &gt; 프로젝트 선택 &gt; <Cmdname sid="statistic" className="uitext" /> &gt; <Cmdname sid="side_tx" className="uitext" />

트랜잭션 통계를 수집합니다. 5분마다 최대 5,000개의 URL 별 수행 통계를 수집하여 서버에 전송합니다. 만약 서로 다른 URL의 수가 5분 동안 5,000개가 넘으면 무시됩니다.

* <code class="btn">T</code> 버튼을 선택하면 <Cmdname sid="top_stack_of_url" className="uitext" /> 메뉴로 이동합니다.

* <code class="btn">U</code> 버튼을 선택하면 <Cmdname sid="unique_stack_url" className="uitext" /> 메뉴로 이동합니다.
...
홈 화면 &gt; 프로젝트 선택 &gt; <Cmdname sid="statistic" className="uitext" /> &gt; <Cmdname sid="side_statDomain" className="uitext" />
...
홈 화면 &gt; 프로젝트 선택 &gt; <Cmdname sid="statistic" className="uitext" /> &gt; <Cmdname sid="side_statCaller" className="uitext" />
...
홈 화면 &gt; 프로젝트 선택 &gt; <Cmdname sid="statistic" className="uitext" /> &gt; <Cmdname sid="side_statReferer" className="uitext" />
...
홈 화면 &gt; 프로젝트 선택 &gt; <Cmdname sid="statistic" className="uitext" /> &gt; <Cmdname sid="side_statError" className="uitext" />
...
홈 화면 &gt; 프로젝트 선택 &gt; <Cmdname sid="statistic" className="uitext" /> &gt; <Cmdname sid="side_statSql" className="uitext" />
...
홈 화면 &gt; 프로젝트 선택 &gt; <Cmdname sid="statistic" className="uitext" /> &gt; <Cmdname sid="side_statHttpc" className="uitext" />
...
홈 화면 &gt; 프로젝트 선택 &gt; <Cmdname sid="statistic" className="uitext" /> &gt; <Cmdname sid="side_statRemote" className="uitext" />
...
홈 화면 &gt; 프로젝트 선택 &gt; <Cmdname sid="statistic" className="uitext" /> &gt; <Cmdname sid="side_statUseragentDetail" className="uitext" />
