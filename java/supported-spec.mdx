...
Web Application Server (WAS) 뿐 아니라 데몬 및 배치 애플리케이션 등 JVM에서 동작하는 모든 애플리케이션에 적용할 수 있습니다. Java 1.5 이하는 support@whatap.io으로 문의하거나 [다음 문서](add-jvm-opt/java-under-ver)를 참조하세요.
