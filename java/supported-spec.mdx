...
Web Application Server (WAS), 데몬, 배치 애플리케이션 등 JVM 기반 모든 애플리케이션에 적용할 수 있습니다. Java 1.6 미만은 support@whatap.io로 문의하거나 [다음 문서](add-jvm-opt/java-under-ver)를 참고하세요.
...
### 지원 버전
  ...
  <td align="center" colspan="3">Fully support</td>
  </tr>
  </tbody>
  </table>
