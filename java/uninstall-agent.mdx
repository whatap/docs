...
1. 왼쪽 메뉴에서 <Cmdname sid="side_management" className="uitext" /> &gt; <Cmdname sid="side_agentUpdate" className="uitext" />로 이동하세요.

1. <Cmdname sid="other_versions" className="uitext" /> 버튼을 클릭하세요.
