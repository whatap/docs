...
MTRACE와 관련한 자세한 내용은 [다음 문서](../java/trs-multi-trace)를 참조하세요.

:::

![MSA 분석](https://img.whatap.io/media/images/whatap_application_analysis_msa_2.png)

위 통계 데이터 중 조회를 원하는 URL의 ![상세 아이콘](/img/ic-pageview.svg) ***상세*** 아이콘을 선택하면 상세 보기 창이 나타납니다. 상세 보기 창에서 해당 URL에 대한 ***Caller Callee 요약***, ***Caller Callee 데이터***, ***Caller Callee 추이*** 등의 상세 데이터 조회가 가능합니다. 
