...
| 기준 뷰  | 그룹화 속성                                                                                                                        |
| -------- | ---------------------------------------------------------------------------------------------------------------------------------- |
| Container | 미설정 (All)<br/>Node<br/>Namespace<br/>Deployment<br/>ReplicaSet<br/>Pod<br/>ContainerName<br/>Image |
| Pod      | 미설정 (All)<br/>Node<br/>Namespace<br/>Deployment<br/>ReplicaSetDemonSet<br/>StatefulSet                                             |
