...
홈 화면 &gt; 프로젝트 선택 &gt; <Cmdname sid="dashboard" className="uitext" /> &gt; <Cmdname sid="serviceDashboard" className="uitext" /> 
...
1. 새로운 프리셋 이름을 입력하세요.
    ...
    에이전트 선택 사항을 같이 저장하려면 <Cmdname sid="ITM07345" className="uitext" />을 선택하세요.
