...
***kube-apiserver 대시보드***는 kube-apiserver의 상태와 성능 메트릭을 수집하고 kube-apiserver의 응답시간, 처리량, 요청 실패 등을 추적해 클러스터의 가용성과 성능을 모니터링합니다.

## kube-apiserver 모니터링 활성화 

와탭 쿠버네티스 에이전트 설치 시 다운로드한 *yaml*을 다음 안내에 따라 수정해 활성화하세요. 
