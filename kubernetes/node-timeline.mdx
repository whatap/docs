...
또한 특정 기간 선택 시 해당 기간 동안의 노드 상태를 **상세 보기**를 통해 자세히 확인할 수 있습니다. 자세한 내용은 다음 노드 타임라인 상세 안내를 참조하세요. 
...
* 차트 왼쪽 목록에서 조회하고자 하는 노드 이름을 선택하여 오른쪽 **상세 보기** 창을 통해 해당 노드의 전체 상태를 볼 수 있습니다. 해당 노드가 생성된 시점부터 현재까지의 상태 변화를 타임라인에서 시각적으로 파악할 수 있습니다.
