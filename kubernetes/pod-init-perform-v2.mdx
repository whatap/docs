...
* ***30일 이내 생성된 Pod만 표시*** ![아이콘](/img/ic-toggle-off.svg) 토글을 활성화해 ![지시선 2](/img/number-02.png) 영역의 Pod 목록에서 30일 이내의 Pod만을 조회할 수 있습니다.
  ...
  ***Pod 시작 분석*** 메뉴는 Pod 생성일로부터 최근 30일 이내의 범위 안에서 5분간의 Pod 시작 데이터를 분석합니다. 즉 생성 후 30일이 지난 Pod의 경우 시작 성능을 분석할 수 없습니다. 
...
![지시선 2](/img/number-02.png) 영역 Pod 목록에서 분석을 원하는 항목의 가장 왼쪽에 ![자세히 보기 아이콘](/img/ico-detail-view.svg) 버튼을 선택하세요. 선택한 Pod의 컨테이너별 시작 성능을 구간별로 분석한 내용을 다음과 같이 확인할 수 있습니다.
