...
* ![새로고침 아이콘](/img/ico-refresh.svg) ***새로 고침*** 아이콘을 선택해 ![지시선 2](/img/number-02.png) 영역의 Pod 목록을 다시 불러올 수 있습니다. 
...
![지시선 2](/img/number-02.png) 영역에서 Pod 목록을 확인할 수 있습니다. 컬럼 정보는 [다음](#pod-init-table)을 참조하세요. Pod 목록에서 분석을 원하는 항목의 가장 왼쪽에 ![자세히 보기 아이콘](/img/ico-detail-view.svg) 버튼을 선택하세요. 선택한 Pod의 컨테이너별 시작 성능을 구간별로 분석한 내용을 다음과 같이 확인할 수 있습니다.
