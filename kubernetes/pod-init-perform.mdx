...
***Pod 초기화 성능*** 목록은 다음과 같이 <Cmdname sid="pod_info" className="uitext" />와 Pod 초기화 타임라인에 따라 컬럼을 분류할 수 있습니다.
...
* <Cmdname sid="ITM07168" className="uitext" />: Pod에 존재하는 컨테이너의 재시작 수의 합을 의미합니다. 
...
* <Cmdname sid="ITM07176" className="uitext" />: 초기화가 완료된 시점에 대한 데이터를 의미합니다. 