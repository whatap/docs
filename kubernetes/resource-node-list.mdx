...
![노드 목록](https://img.whatap.io/media/images/whatap_kubernetes_resource_node_list.png)
...
![노드 상세](https://img.whatap.io/media/images/whatap_kubernetes_resource_node_detail.png)
