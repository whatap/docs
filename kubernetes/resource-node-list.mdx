...
* ![number 02](/img/number-02.png) 영역에서 OnodeName 컬럼 하위의 ![상세 아이콘](/img/ic-pageview.svg) ***상세*** 아이콘 선택 시 해당 노드의 상세 페이지로 이동합니다. 

  :::note 

  ***노드 상세***에 대한 자세한 내용은 [다음 문서](#nodedetails)를 참조하세요.
