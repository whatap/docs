...
자바 에이전트 2.1.1 버전부터 가능합니다. 업데이트 방법은 [다음 문서](../java/update-agent)를 참고하세요.
...
**로그 모니터링 시작하기** 탭의 **2.** <Cmdname sid="use_log_monitoring" className="uitext" />에서 와탭 로그 모니터링을 활성화 또는 비활성화 할 수 있습니다.
