...
와탭 모니터링 서비스 초기 화면에서 프로젝트를 선택한 후, **로그** > **로그 설정** 메뉴를 클릭하세요. **로그 모니터링 시작하기** 탭의 **1. 에이전트 설정 확인**의 안내를 참고해 에이전트 설정을 확인합니다.
...
**로그 모니터링 시작하기** 탭의 **2. 로그 모니터링 활성화**에서 와탭 로그 모니터링을 활성화 또는 비활성화 할 수 있습니다.
