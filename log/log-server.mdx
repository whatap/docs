...
와탭 모니터링 서비스 초기 화면에서 프로젝트를 선택한 다음 프로젝트 메뉴 하위에 ***로그*** > ***설정*** 메뉴를 선택하세요. 상단 영역의 OS 탭에서 서버 OS(***리눅스(shell)***, ***윈도우(Powersehll)***)를 선택하세요. ***기본 설치*** 또는 ***카테고리와 함께 설치***를 참조해 진행하세요. 다음 설정은 에이전트 재시작이 필요합니다.
