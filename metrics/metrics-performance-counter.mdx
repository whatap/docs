...
:::note
사용 중인 WAS, 프레임워크 관련 [문서](https://www.ibm.com/support/knowledgecenter/ko/SS7K4U_liberty/com.ibm.websphere.wlp.zseries.doc/ae/rwlp_mon_threadpool.html)를 참고해 Mbean 정보를 확인하세요.
:::
