...
와탭 Android <Cmdname sid="TTL10497" className="uitext" /> 서비스를 사용하기 위해서는 [회원 가입](https://www.whatap.io/ko/signup/) 후 프로젝트를 생성하고 Android 애플리케이션에 와탭 Android 에이전트를 적용해야 합니다.
...
[와탭 서비스](https://service.whatap.io) 페이지로 이동해 <Cmdname sid="TTL10497" className="uitext" />을 시작하세요. 
앞서 생성한 프로젝트를 선택한 다음 <Cmdname sid="side_dashboard" className="uitext" /> &gt; <Cmdname sid="ITM10591" className="uitext" /> 메뉴로 이동하세요. 