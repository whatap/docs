...
:::note
MXQL을 알아보기 전에 메트릭스의 개념에 대해 먼저 알아보길 권장합니다. 메트릭스에 대한 자세한 내용은 [다음 설명서](../metrics/common-metrics-intro)를 참조하세요.
:::
...
![MXQL 실행 결과 예시](https://img.whatap.io/media/images/mxql_overview.png)
