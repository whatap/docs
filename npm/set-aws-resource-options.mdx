...
## EC2 환경에서 AWS 리소스 권한 설정하기 {#set-aws-resource-ec2}
...
AWS IAM 정책 설정 과정에서 최소 권한을 지정하도록 요구됩니다. **NPM**에서 AWS 리소스 정보를 수집하려면 `ec2:DescribeNetworkInterfaces` 권한이 필요합니다.
...
## EKS 환경에서 AWS 리소스 권한 설정하기 {#set-aws-resource-eks}
