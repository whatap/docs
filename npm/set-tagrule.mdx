...
에이전트에서 수집하는 기본 태그와 더불어 사용자가 쉽게 변경하고 적용할 수 있는 룰을 만들었습니다. 에이전트 설치 경로(*/usr/whatap/whtap-npmd*)에 *tagRule.yaml* 파일을 수정해 옵션을 적용할 수 있습니다.
...
```java title='zookeeper process name'
