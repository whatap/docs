...
**Span**의 `attribute` 객체가 와탭의 에이전트 설정과 어떻게 연관되는지 다음 코드를 참조하세요.
...
* OpenTelemetry에서 제공하는 속성(`attribute`)에 대한 자세한 내용은 다음 링크를 참조하세요.
