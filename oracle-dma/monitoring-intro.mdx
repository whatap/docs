...
와탭의 Oracle DMA는 민감한 Oracle 데이터베이스를 사용하는 고객을 위해 Direct Memory Access 기술을 사용해 모니터링하는 기능을 제공합니다. DMA 기술은 데이터베이스 성능 정보를 DB 서버에 부하없이 수집할 수 있어 기본 0.1초에서 최대 0.01초 간격으로 세션 및 SQL을 수집 가능하게 하고, DB 장애나 Hang 상황에서도 데이터를 수집할 수 있습니다.
