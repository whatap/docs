...
tags: [ PostgreSQL, 데이터베이스, 분석, Wait 분석 ]
---
...
조회를 원하는 ***시간***과 ***인스턴스***를 선택하세요. 설정한 시간과 인스턴스에 해당하는 Wait 정보를 확인할 수 있습니다. 조회 기간 동안 대기(지연)가 자주 발생한 액티브 세션들이 있다면 어떤 종류의 Wait 이벤트가 발생했는지 분석하는데 활용할 수 있습니다.
