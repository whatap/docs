...
[whatap-agent.tar.gz](https://s3.ap-northeast-2.amazonaws.com/repo.whatap.io/alpine/x86_64/whatap-agent.tar.gz)을 다운받고 '/' 디렉토리 기준으로 압축을 해제합니다. */usr/whatap/agent* 디렉토리에 모니터링 설치 파일이 생성됩니다.
