...
| page.url | <span class='type'>String</span> | 이벤트가 발생한 페이지 URL입니다. | https://site.whatap.io/8/dashboard?dataKey=abcd |
...
| pageLocation | <span class='type'>String</span> | 라우터 변경 이벤트가 발생한 페이지 URL입니다. | https://site.whatap.io/8/dashboard?dataKey=abcd |
...
| url | <span class='type'>String</span> | 리소스 URL입니다. | https://unpkg.com/purecss@2.0.3/build/pure-min.css?dataKey=abcd |
| urlHost | <span class='type'>String</span> | 리소스 URL의 도메인 이름입니다. | unpkg.com |
| urlPath | <span class='type'>String</span> | 리소스 URL의 경로입니다. | /purecss@2.0.3/build/pure-min.css |
...
| url | <span class='type'>String</span> | 에러 타입이 `xhr`, `fetch`의 경우 AJAX 요청 URL입니다. | https://site.whatap.io/yard/api?pcode=8&type=summary |
