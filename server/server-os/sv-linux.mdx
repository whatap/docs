...
1. {@include: ../../apm/php-os/_pcg-install.mdx}  
    ![number-s](/img/number-03.png) ***와탭 서버 모니터링 패치 설치*** 탭에서 해당하는 명령어를 복사하여 입력합니다.
...
1. **설정 스크립트**를 실행하세요.  
    ![number-s](/img/number-04.png) ***서버 모니터링 시작하기*** 탭으로 이동하여 명령어를 발급 받거나, 하단의 명령어에 프로젝트 액세스 키와 서버 IP를 추가하여 실행하세요.
...
{@include: ../_sv-tcp6600.mdx}

<details>
<summary>서버 에이전트 파일 구성</summary>

{@include: _sv-cpf.mdx} 
{@include: _sv-lf-cpf.mdx}               
