...
1. 원하는 ***지표***의 ***레벨***, ***지속 시간***, ***활성화*** 여부를 설정하세요.
    ...
    * ***레벨***: <Cmdname sid="sms_alert_warn" className="slow" /> 혹은 <Cmdname sid="sms_alert_fatal" className="vslow" /> 수준을 선택할 수 있습니다.

    * ***지속 시간***:  설정한 임곗값의 ***지속 시간*** 이후 서버의 상태가 <Cmdname sid="sms_alert_warn" className="slow" />, <Cmdname sid="sms_alert_fatal" className="vslow" /> 수준으로 변경됩니다.
...
홈 화면 &gt; 프로젝트 선택 &gt; <Cmdname sid="side_event" className="uitext" /> &gt; <Cmdname sid="side_eventSetting" className="uitext" /> &gt; ***로그 파일/윈도우 이벤트*** 탭 &gt; ***+ 이벤트 추가*** 버튼 선택
...
1. 이벤트의 ***위험도***를 선택하세요. <Cmdname sid="sms_alert_fatal" className="vslow" /> 혹은 <Cmdname sid="sms_alert_warn" className="slow" /> 수준을 선택할 수 있습니다.
