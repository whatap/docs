...
proxy 설치 파일은 [https://repo.whatap.io/agent_proxy/whatap_agent_proxy.zip](https://repo.whatap.io/agent_proxy/whatap_agent_proxy.zip)에서 다운로드할 수 있습니다.
압축을 해제한 후, 파일을 와탭 수집 서버와 통신 가능한 서버에 저장하세요.
