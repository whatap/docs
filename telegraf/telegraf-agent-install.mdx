...
와탭 서비스를 사용하기 위해서는 [회원 가입](https://www.whatap.io/ko/signup/) 후 프로젝트를 생성하고 대상 서버에 에이전트를 설치해야 합니다. 회원 가입에 관한 자세한 내용은 [다음 설명서](../account/account-manage)를 참조하세요.
...
Telegraf 에이전트 설치를 완료했습니다. [다음 문서](tf-troubleshooting)에서 설치 문제 해결 방법을 확인하세요.
