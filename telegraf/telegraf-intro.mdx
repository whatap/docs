...
![Telegraf - 와탭 연동 구조](https://www.whatap.io/ko/blog/46/img/blog_46_01.webp)
...
Telegraf에 포함된 와탭 output plugin을 활용하거나 와탭 Telegraf 에이전트를 설치하여 Telegraf에서 수집하는 메트릭스를 와탭 수집 서버로 전달할 수 있습니다. 
