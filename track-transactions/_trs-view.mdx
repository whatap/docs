...
현재 프로젝트와 연결된 에이전트를 선택해 필터링할 수 있습니다. ![아이콘](/img/ic-search-on-press.svg) ***돋보기*** 아이콘을 클릭하면 ![number2](/img/number-02.png) **히트맵 트랜잭션 차트**를 볼 수 있습니다. 
...
실시간 히트맵 차트를 드래그하면 ![number4](/img/number-04.png) **선텍 영역 에이전트 목록**과 ![number5](/img/number-05.png) **트랜잭션 목록**과 같은 상세 분석 화면을 볼 수 있습니다.

#### ![number4](/img/number-04.png) 선택 영역 에이전트 목록
차트에서 선택된 영역에 포함되는 트랜잭션 수와 에러 수를 확인할 수 있습니다. 목록 중에서 원하는 애플리케이션을 선택하면 그 애플리케이션의 ![number5](/img/number-05.png) **트랜잭션 목록**에 세부 정보가 나타납니다.

#### ![number5](/img/number-05.png) 트랜잭션 목록
트랜잭션 목록은 세부 정보를 가지고 있습니다. 목록에서 원하는 트랜잭션을 클릭하면 해당 트랜잭션의 **프로파일 상세 내용 분석** 화면을 볼 수 있습니다. 트랜잭션 프로파일 상세 분석은 [다음 문서](php-trs-profile#상세-분석)를 참조하세요.
