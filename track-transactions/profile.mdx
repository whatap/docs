...
***분석*** > ***히트맵*** 메뉴를 선택하고 실시간 히트맵을 드래그하면 **상세 분석** 화면이 나타납니다. 화면 안내에 대한 자세한 내용은 [다음 설명서](trs-view#상세-분석)를 참조하세요. 
...
![profile_apm](/img/trs-profile-detail-view-upper.png)
...
***프로파일 다이어그램***은 트랜잭션 수행 상세 이력입니다. 수행 상세 이력을 보여주기 위한 각 칼럼의 **트랜잭션 프로파일 정보**는 다음과 같습니다.
