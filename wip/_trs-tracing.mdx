...
***분석*** > ***히트맵*** 메뉴를 선택하고 실시간 히트맵을 드래그하면 아래로 ***TX 프로파일*** 테이블 목록이 나타납니다. 드래그한 영역의 트랜잭션 정보를 ***TX 프로파일*** 테이블 목록에서 확인할 수 있습니다. 목록에서 항목을 선택하면 해당 트랜잭션의 ***통계*** 정보 창을 확인할 수 있습니다. 와탭은 트랜잭션의 성능을 분석하기 위해 이름과 클라이언트 정보 등의 속성, 트랜잭션의 처리 성능 그리고 각 구간별 상세 수행이력을 수집하고 보여줍니다.  ***통계*** 창을 통해 상세 분석 요소를 살펴보겠습니다. 
...
상단 오른쪽 ***더보기*** 버튼을 선택하면 다음과 같이 상세한 트랜잭션 속성과 성능 정보가 나타납니다.
...
* **ACTIVE STATCK** 액티브 스택이 수집되었음을 의미합니다. 선택하면 ![number-s3](/img/number-03.png)에서 액티브 스택을 확인할 수 있습니다.
...
***메소드 분석***을 선택하면 트레이스 스탭 정보에서 중복 실행된 메소드에 대한 분석 정보를 제공합니다. ***SQL 분석***을 선택하면 트레이스 스탭 정보에서 중복 실행된 SQL문에 대한 분석 정보를 제공합니다.
